package com.shenxuan.common.exception;

import com.shenxuan.common.constans.MyConfig;
import com.shenxuan.common.pojo.addition.ResultInfo;
...
public class CustomExceptionResolver implements HandlerExceptionResolver {
     ...
     */
    private void writeErrorUseLog4j(Exception ex, HttpServletRequest request) {
        ...
        try {
            ...
            if (ex instanceof CustomException) {
                ...
                logger.error("referer url is " + referer);
    ...
    private ModelAndView resolveJsonException(HttpServletRequest request, HttpServletResponse response, Object handler,
        ...
        try {
            ...
            //response.getWriter().write(submitResultInfo, MediaType.APPLICATION_JSON, outputMessage);
            String message = submitResultInfo.getResultInfo().getMessage();
