package com.shenxuan.common.constans;
...
public class MyConfig {
	 ...
	 * 数据状态不可用
	 */
	public static final int DATA_STATUS_NO = 0;
	 ...
	 * 学时达标状态
	 */
	public static final int STUDY_TIME_PASS = 1;

	/**
	 * 学时未达标状态
	 */
	public static final int STUDY_TIME_NO_PASS = 0;
	 ...
	 * 考核未达标状态
	 */
	public static final int EXAM_NO_PASS = 0;
