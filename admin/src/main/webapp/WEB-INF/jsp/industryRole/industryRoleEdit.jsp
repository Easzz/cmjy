...
<body>
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form class="form-horizontal m-t" id="industryRoleForm" action="${projectPath }/industryRole/industryRoleEdit.action" method="post">
            ...
            <div class="form-group">
                <label class="col-sm-3 control-label">考核达标分数：</label>
                <div class="col-sm-8">
                    <input id="totalStudyTime" name="standardExamScore" value="${industryRole.standardExamScore }" class="form-control" type="number" required="required">
                </div>
            </div>
            <div class="form-group">
