...
<body>
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <form class="form-horizontal m-t" id="dicInfoForm" action="${contextPath }/dicInfo/dicInfoAdd.action" method="post">
                ...
                <div class="col-sm-8">
                   	<select name="dicTypeId" class="form-control" required="required">
	        			...
	        			<c:forEach items="${dicTypes }" var="dictType">
	        				<option value="${dictType.id }">${dictType.typeValue }</option>
	        			</c:forEach>
                   	</select>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input name="infoName" class="form-control" type="text" required="required">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">值：</label>
                <div class="col-sm-8">
                    <input  name="infoValue" class="form-control" type="text" required="required">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">排序：</label>
                <div class="col-sm-8">
                    <input name="sort" class="form-control" type="number" required="required">
                </div>
            </div>
            <div class="form-group">
