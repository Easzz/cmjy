...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <form class="form-horizontal m-t" id="employeeForm" action="${projectPath }/employee/employeeBatchAdd4Gov.action"
          method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input id="employeeListExcel" name="employeeListExcel" class="form-control" type="file"
                       required="required">
                <div id="danger"><p class="help-block"><a href="${projectPath }/download/批量添加从业人员模板(危险品货运).xlsx"
                                                          target="_blank">模板下载</a></p></div>
                <div id="passengerSransport"><p class="help-block"><a
                        href="${projectPath }/download/批量添加从业人员模板(公路客运).xlsx" target="_blank">模板下载</a></p></div>
            </div>
        </div>
            ...
            $(form).ajaxSubmit({
                    ...
                    success: function (data) {
                        if (data.resultInfo.success) {
                            ...
                            var excelPath = data.resultInfo.sysdata.excelPath;
                            if (excelPath) {
                                //页面层-自定义
                                parent.layer.alert('<a href="' + excelPath + '">点击下载失败文件</a>');
                            } else {
